...
$vendas = selecionarTodos($conexao, 'pedido');
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Todas os pedidos</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                                <li class="breadcrumb-item active">Todas os pedidos</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Todas os pedidos</h4>
                                <h6 class="card-subtitle">pedidos feitos em <code>todo o período</code></h6>
                                    ...
                                    <table class="table color-bordered-table primary-bordered-table">
                                        ...
                                        <tbody>
                                           <?php foreach ($vendas as $key) {
                                                $cliente = selecionarUnico($conexao, 'fornecedor', 'id', $key["id_fornecedor"]);
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="alterar-pedido.php?id=<?php echo $key['id']; ?>">Alterar</a>
                                                                <a class="dropdown-item" href="#" onclick="deletar(<?php echo $key["id"]; ?>, 'pedido')">Excluir</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="color: grey;">Produtos Pedidos</h5>
                                    ...
                                    <table class="table color-bordered-table primary-bordered-table">
                                        ...
                                        <tbody>
                                             <?php foreach ($venda as $varios) { 
                                                ?>
                                                <tr>
                                                    <td><?php echo $varios["id"]; ?></td>
                                                     <td> <?php echo $varios["nome"]; ?></td>
                                                    <td>R$<?php echo $varios["preco"]; ?></td>
...
<div class="modal fade" <?php echo 'id="alterar-status'.$key["id"].'"'; ?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="alterar-status-pedido.php" method="POST">
          <div class="form-group">
           <label for="cod" style="color: grey;">Qual o status atual do pedido?</label>
