...
$vendas = selecionarTodosPeriodo($conexao, 'venda', date('Y-m-d', strtotime('-7 days')), date('Y-m-d'));
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Todas as Vendas Semanais</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                                <li class="breadcrumb-item active">Todas as Vendas Semanais</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Todas as vendas Semanais</h4>
                                <h6 class="card-subtitle">Vendas feitas nos <code>últimos 7 dias</code></h6>
